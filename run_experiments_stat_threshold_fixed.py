...
# create session:
# tmux new -s marinas1stsession
# tmux attach -t marinas1stsession Cntrl+b d για να αποσυνδεθείς
# tmux kill-session -t marinas1stsession για να κλείσει το session
# tmux ls για να δεις τα sessions
# tmux new -s marina_ITE
...
def keep_metrics(
    ...
    out_root, run_name, model, device, threshold
):
